...
const PostImage = ({ postlink, userimage, username }) => {
  ...
  return (
    <>
      ...
      >
        <View className="flex flex-col gap2">
      ...
      <Modal visible={openModal}  transparent={true} animationType="fade">
        ...
        >
          ...
          >
            <View className="justify-center h-12 px-2 bg-white rounded-t-lg dark:bg-zinc-800">
            ...
            <View className="justify-center h-12 bg-white rounded-b-lg dark:bg-zinc-800">
              <View
